...
ds = create_dataset.TextDataset(texts=texts,tokenizer=toker,stride=128)
# print(ds[1])
...
configuration = trainer.Config(model=llm, train_dataset=ds, epochs=10, batch_size=1, lr=1e-3,save_dir="gpt_128")
